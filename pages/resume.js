...
import Resume from "../public/Official_Resume.png";
        ...
        <section>
            <div className='pt-7 pb-5 pl-5 bg-resumeTitle text-2xl text-white flex justify-between'>
                ...
                <div className='flex items-center mr-3'>
                    ...
                    <a href="/"><div className='bg-gray-500 hover:bg-gray-600 active:bg-gray-700 m-2 ml-4 px-2 py-1 text-sm rounded-md lg:mr-6 lg:text-lg lg:py-2 lg:px-6'>
                       Home
                    </div></a>
                </div>
            </div>
